...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Platform subscription plans typically added on the Stripe dashboard.
    ...
    */
    ...
    'plans' => [
        'monthly' => [
            ...
            'price_id' => env('STRIPE_MONTHLY_PRICE_ID', 'price_1R93or09B5M4fBGEgh0jNTCi'),
        ],
        'yearly' => [
            'name' => 'Yearly Subscription',
            'price_id' => env('STRIPE_YEARLY_PRICE_ID', 'price_1R93pU09B5M4fBGEo0ropYGl'),
        ],
    ],
