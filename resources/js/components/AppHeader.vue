<script setup>
    ...
    const activeItemStyles = computed(() => (url) => (isCurrentRoute.value(url) ? 'text-gray-900 dark:bg-gray-800 dark:text-gray-100' : ''))
                            ...
                            <div class="flex h-full flex-1 flex-col justify-between space-y-4 py-6">
                                <nav class="-mx-3 space-y-1">
                                    <Link
                                        ...
                                        :key="item.title"
                                        :href="item.href"
                                        class="flex items-center gap-x-3 rounded-lg px-3 py-2 text-sm font-medium hover:bg-gray-200"
                            ...
                            <Button
                                ...
                                <Avatar class="size-8 overflow-hidden rounded-full">
                                    <AvatarImage
                                        ...
                                        :alt="auth.user.name" />
                                    <AvatarFallback class="rounded-lg bg-gray-200 font-semibold text-black dark:bg-gray-700 dark:text-white">
